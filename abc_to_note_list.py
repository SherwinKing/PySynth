...
abc_to_note_list.py filename [output_filename] [num_song] [--syn_b/--syn_c/--syn_d/--syn_e/--syn_p/--syn_s/--syn_samp]
...
except: output_filename = "note_list.txt"

try: num = int(sys.argv[3])
except: num = 1
song = []
